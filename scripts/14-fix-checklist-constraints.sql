-- Migration 14: Fix foreign key constraints
-- 14-fix-checklist-constraints.sql

USE sistema_chamados;

-- Primeiro, se já existir, remover constraints da tabela
DROP TABLE IF EXISTS checklist_item_responses;
...
CREATE TABLE IF NOT EXISTS checklists (
  ...
  created_by CHAR(36), -- Removi NOT NULL
...
-- Tabela de execuções de checklist (registro de quando um colaborador preencheu)
